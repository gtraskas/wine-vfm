"""Ephemeral Modal function serving the fine-tuned wine VFM specialist.

Loads the base model + LoRA adapter fresh on every invocation — no caching,
no persistent deployment. Useful for a one-off smoke test via `app.run()`
before committing to a deployed service (see specialist_service.py).
"""

import modal
from modal import Image

app = modal.App("wine-vfm-specialist-ephemeral")
